...
public class BCRAFile {
    ...
    public static List<String> RITxx1xxxx(Integer cantTarjetas, LocalDate dateTo) {

        // TARJCRED.txt

        List<String> list = new ArrayList<>();

        list.add(RITxx1xxxx("11000", cantTarjetas, dateTo));
        list.add(RITxx1xxxx("13100", cantTarjetas, dateTo));
        list.add(RITxx1xxxx("14200", cantTarjetas, dateTo));
        list.add(RITxx1xxxx("15200", cantTarjetas, dateTo));
        list.add(RITxx1xxxx("16100", cantTarjetas, dateTo));

        return list;
    }

    public static String RITxx1xxxx(String nroPartida, Integer cantTarjetas, LocalDate dateTo) {
        ...
        sb.append(
                dateTo.format(DateTimeFormatter.ofPattern("yyyyMM"))
        ); // Fecha (8)
        /*
        sb.append(
